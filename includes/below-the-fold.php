...
<div class="row">
	<div id="below-the-fold" class="row-border-bottom-top">
		<div class="span3" id="below-the-fold-left">
			<?php if(!function_exists('dynamic_sidebar') or !dynamic_sidebar('Below the Fold - Left')):?><?php endif;?>
		</div>
		<div class="span5" id="below-the-fold-center">
			<?php if(!function_exists('dynamic_sidebar') or !dynamic_sidebar('Below the Fold - Center')):?><?php endif;?>
		</div>
