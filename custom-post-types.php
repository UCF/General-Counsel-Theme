...
class Page extends CustomPostType {
	...
	public function fields() {
		...
		return array(
			array(
				'name' => 'Show Lower Section',
				'desc' => 'This section is normally blank.  Check this box to display the "Below the Fold" widgets (Office Locations, Mission Statement, and Notices) on this page.',
				'id'   => $prefix.'show_fold',
				'type' => 'checkbox',
			),
				array(
...
class Notice extends CustomPostType{
	 ...
	 **/
	public function toHTML($object){
		$title = Notice::get_title($object);
		$url   = Notice::get_url($object);
		$html = "<a href='{$url}'>{$title}</a>";
		return $html;
	}
}
